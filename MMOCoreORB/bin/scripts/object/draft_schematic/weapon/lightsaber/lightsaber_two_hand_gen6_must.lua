...
object_draft_schematic_weapon_lightsaber_lightsaber_two_hand_gen6_must = object_draft_schematic_weapon_lightsaber_shared_lightsaber_two_hand_gen6_must:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "6th Generation Two Handed Lightsaber",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_two_hand_gen6_must, "object/draft_schematic/weapon/lightsaber/lightsaber_two_hand_gen6_must.iff")
