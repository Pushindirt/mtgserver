...
object_draft_schematic_weapon_lightsaber_lightsaber_polearm_gen6 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_polearm_gen6:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Darth Push Double-Bladed Lightsaber",
   ...
   targetTemplate = "object/weapon/melee/polearm/crafted_saber/sword_lightsaber_polearm_gen6.iff",


}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_polearm_gen6, "object/draft_schematic/weapon/lightsaber/lightsaber_polearm_gen6.iff")
