...
object_draft_schematic_weapon_lightsaber_lightsaber_gen6 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_gen6:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Sixth Generation Lightsaber",
   ...
   targetTemplate = "object/weapon/melee/sword/crafted_saber/sword_lightsaber_gen6.iff",

   additionalTemplates = {
              }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_gen6, "object/draft_schematic/weapon/lightsaber/lightsaber_gen6.iff")
