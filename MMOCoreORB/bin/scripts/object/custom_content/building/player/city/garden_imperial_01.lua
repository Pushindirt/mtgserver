object_building_player_city_garden_imperial_01 = object_building_player_city_shared_garden_imperial_01:new {
	lotSize = 0,
...
ObjectTemplates:addTemplate(object_building_player_city_garden_imperial_01, "object/building/player/city/garden_imperial_01.iff")
